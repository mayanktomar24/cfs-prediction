...
lr = pickle.load(open(r'C:\Users\DELL\Downloads\deployemnt\lr1.pkl', 'rb'))  # rb = read binary
dt = pickle.load(open(r'C:\Users\DELL\Downloads\deployemnt\dt1.pkl', 'rb'))  # rb = read binary
rf = pickle.load(open(r'C:\Users\DELL\Downloads\deployemnt\rf1.pkl', 'rb'))  # rb = read binary
